        ...
        if ($query) {
            if ($query->num_rows > 0) {
                ...
                $mailhtml .= "<p>Greetings from Linkers India!</p>
                                ...
                                <p>Thanks!</p>
                                <p>Best Regards,<br>Team LINKER'S INDIA";
                                    
                   $mailhtml .= '<br>211, Bakhatgarh Tower,10/1, New Palasiya,Indore -452001.<br>Ph. 0731-4044406,Cell  8349998444<br><a href="mailto:support@linkersindia.in" target="_blank">support@linkersindia.in</a></p>
                                </div>';
                ...
                $innerstaff.= "<p>Best Regards,<br>Team LINKER'S INDIA";
                    
               $innerstaff.='<br>211, Bakhatgarh Tower,10/1, New Palasiya,Indore -452001.<br>Ph. 0731-4044406,Cell  8349998444<br><a href="mailto:support@linkersindia.in" target="_blank">support@linkersindia.in</a></p>
                                </div>';
    ...
    function add_property_master($data) {
        ...
        if ($query) {
            if ($query->num_rows > 0) {
                ...
                $psradded .= '<br>211, Bakhatgarh Tower,10/1, New Palasiya,Indore -452001.<br>Ph. 0731-4044406,Cell  8349998444<br><a href="mailto:support@linkersindia.in" target="_blank">support@linkersindia.in</a></p>
                                </div>';
                ...
                $psraddInternalStaff .="<p>Best Regards,<br>Team LINKER'S INDIA";
                    
                   $psraddInternalStaff .= '<br>211, Bakhatgarh Tower,10/1, New Palasiya,Indore -452001.<br>Ph. 0731-4044406,Cell  8349998444<br><a href="mailto:support@linkersindia.in" target="_blank">support@linkersindia.in</a></p>
                                <p>&nbsp;</p><div>&nbsp;</div></div>';
    ...
    function add_requirement_master($data) {
        ...
        if ($query) {
            if ($query->num_rows > 0) {
                ...
                $Rfaddtointernalstaff.="<p>Best Regards,<br>Team LINKER'S INDIA<br>";
                 $Rfaddtointernalstaff.='211, Bakhatgarh Tower,10/1, New Palasiya,Indore -452001.<br>Ph. 0731-4044406,Cell  8349998444<br><a href="mailto:support@linkersindia.in" target="_blank">support@linkersindia.in</a></p>
                                        </div>';
                ...
                if ($insert) {
                    ...
                    $RFaddmail .="<p>Greetings from Linkers India!</p>
                                    ...
                                    <p>Thanks!</p>
                                    <p>Best Regards,<br>Team LINKER'S INDIA";
                    $RFaddmail .='<br>211, Bakhatgarh Tower,10/1, New Palasiya,Indore -452001.<br>Ph. 0731-4044406,Cell  8349998444<br><a href="mailto:support@linkersindia.in" target="_blank">support@linkersindia.in</a></p>
                                    </div>';
