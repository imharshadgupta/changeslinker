...
//            
    ...
    // create new PDF document
        ...
        $tbl.="<tr>
			   ...
			   <tr style=\"background-color:#CCCCCC; font-size:38px;\">
				...
				<td width=\"70%\" align=\"left\"><b>Requirement</b></td>
    ...
    // create new PDF document
     ...
     function need_sourcewise_reports($cmbSource,$txtDate,$cmbFilter)
     {
        ...
        if($cmbFilter==1)
        {
            $sql = "select requirement_master.dDate,
                requirement_master.cRequirementTitle From  requirement_master Where requirement_master.iSourceId='".$cmbSource."' AND requirement_master.dDate='".$DCRDate."' ORDER By iRequirementId DESC";
        ...
        }elseif($cmbFilter==2)
        {
                ...
                client_master.cClientName From  client_master Where client_master.iSourceId='".$cmbSource."' AND client_master.dCreateDate='".$DCRDate."' ORDER By iClientId DESC";
            
        }
        elseif($cmbFilter==3)
        {
              $sql = "select property_master.dDate,
                property_master.cPropertyName From  property_master Where property_master.iSourceId='".$cmbSource."' AND property_master.dDate='".$DCRDate."' ORDER By iPropertyId DESC";
