...
//        AND property_master.bDelete=0)';
        ...
        if ($cmbPropertyStatus != "") {
            $sql .= " property_master.iPropertyStatusId = '" . $cmbPropertyStatus . "'";
        }
...
//            $sWhere = substr_replace( $sWhere, "", -3 );
        ...
        foreach ($rResult->result_array() as $aRow) {
            ...
            $row[3] = $Active;
            $row[4] = $staffname;
            $row[5] = $viewporturlsht;
            $row[6] = $editurls;
            $row[7] = $propertyhistorys;
...
//	  exit;
    ...
    function pending_rf_print_report() {
        ...
        //Close and output PDF document
        return $pdf->Output('pending_rf_report.pdf', 'FD');
    ...
    function available_properties_print_report() {
        ...
        //Close and output PDF document
        return $pdf->Output('psr_pending_acceptance_report.pdf', 'FD');
...
//            
    ...
    function requirement_aging_report() {
//       // error_reporting(E_ALL);
        ...
        $sql = "SELECT dcr_summary.dDCRDate as dAddedOnDate,user_master.cName,task_master.cTaskName,property_master.cPropertyName,requirement_master.cRequirementTitle,
                CMREQ.cClientName as cReqClientName,CMPROP.cClientName as cPropClientName 
                ...
                AND requirement_master.cRequirementTitle<>'' ORDER BY dcr_summary.dDCRDate ASC limit 0,100";
