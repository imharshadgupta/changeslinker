...
class Dashboard_model extends CI_Model {
    ...
    function search_by_text_in_property($txtSearch, $cmbPropertyCategory, $cmbPropertyType, $cmbPropertyStatus, $cmbState, $cmbCity, $cmbLocation) {
...
//        AND property_master.bDelete=0)';
    ...
    function search_by_text_in_client($txtSearch, $cmbPropertyCategory, $cmbPropertyType, $cmbPropertyStatus, $cmbState, $cmbCity, $cmbLocation) {
    ...
    function search_by_text_in_requirement($txtSearch, $cmbPropertyCategory, $cmbPropertyType, $cmbPropertyStatus, $cmbState, $cmbCity, $cmbLocation) {
