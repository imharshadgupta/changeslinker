...
//            $sWhere = substr_replace( $sWhere, "", -3 );
        ...
        foreach ($rResult->result_array() as $aRow) {
            ...
            $taskurls = '<a  class="iframe" href="' . $taskurl . '"  >+</a>';
...
//            $sWhere = substr_replace( $sWhere, "", -3 );
        ...
        foreach ($rResult->result_array() as $aRow) {
            ...
            $row[0] = $RequirementId;
            $row[1] = $Date;
            $row[2] = $RequirementTitle;
            $row[3] = $CurrentStatusName;
            $row[4] = $AcceptTermsAndConditions;
            $row[5] = $Active;
...
//                echo '</pre>';die;
                ...
                $pdf->Cell(60, 5, "cBranchName :", $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');
...
//				$tbl.="</tr>";
        ...
        if (isset($AttachmentRows) && count($AttachmentRows) > 0) {
            ...
            foreach ($AttachmentRows as $docrow) {
                ...
                $pdf->Image($ImgUrl, 80, $pdf->gety(), 58, 38, $type = '', $link = '', $align = '', $resize = false, $dpi = 200, $palign = '', $ismask = false, $imgmask = false, $border = 0, $fitbox = false, $hidden = false, $fitonpage = false, $alt = false, $altimgs = array());
               ...
               // $pdf->M(20, 60, $SNo . ") " . $AttachmentTitles, $border = 0, $ln = 1, $align = '', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');
                $pdf->MultiCell(60, 5, $SNo . ") " . $AttachmentTitles
