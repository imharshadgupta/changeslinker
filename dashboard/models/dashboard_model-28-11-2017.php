...
//        echo '</pre>';die;
        ...
        if (isset($_GET['sSearch']) && $_GET['sSearch'] != "") {
            ...
            if (is_numeric($_GET['sSearch'])) {
                ...
                //$sWhere .= " OR csm.cCurrentStatusName LIKE '%" . $this->db->escape_like_str($sSearch) . "%' ";
            }

            // $sWhere .= " OR totdcrrf LIKE '%" . $this->db->escape_like_str($sSearch) . "%' ";
...
//		}
    ...
    function get_all_task_assign() {
        $sql = "SELECT task_assign.iTaskAssignId,UMTAB.cName as cTaskAssignedByName,
                ...
                department_master.cDepartmentName,CMREQ.cClientName as cReqClientName,
                ...
                LEFT JOIN department_master ON task_assign.iDepartmentId=department_master.iDepartmentId 
...
//				$tbl.="</tr>";
        ...
        if (isset($AttachmentRows) && count($AttachmentRows) > 0) {
            ...
            foreach ($AttachmentRows as $docrow) {
                ...
                $pdf->Image($ImgUrls, 76, $pdf->gety(), 58, 38, $type = '', $link = '', $align = '', $resize = false, $dpi = 200, $palign = '', $ismask = false, $imgmask = false, $border = 0, $fitbox = false, $hidden = false, $fitonpage = false, $alt = false, $altimgs = array());
                //$pdf->Cell(20, 5, "", $border = 0, $ln = 0, $align = '', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');
                // $pdf->M(20, 60, $SNo . ") " . $AttachmentTitles, $border = 0, $ln = 1, $align = '', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');
