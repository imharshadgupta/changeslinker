...
<h2>RFS PENDING FOR ACCEPTANCE REPORT</h2>
    <div class="mfrminner">

       <form name="frmWeeklyReport" id="frmWeeklyReport" method="post" action="<?php echo base_url();?>index.php/dashboard/rfpendingacceptanceprintreport" target="_blank">
