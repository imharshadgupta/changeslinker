...
<form name="addForm" id="addForm" method="post" action="<?php echo base_url(); ?>index.php/dashboard/add_dcr" enctype="multipart/form-data" target="_blank">
...
&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/dashboard/listing_dcr">
