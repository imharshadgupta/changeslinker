...
<div class="fldblks"><input type="text" name="txtPropertyStatusName" id="txtPropertyStatusName" class="fild" value="<?php echo set_value('txtPropertyStatusName'); ?>" tabindex="1" /></div>
...
function FormValidate(btn)
{
    ...
    else
    {
		...
		var url = "<?php echo base_url(); ?>index.php/dashboard/add_property_status_master";
