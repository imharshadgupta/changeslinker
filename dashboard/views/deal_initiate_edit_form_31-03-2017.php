                ...
                <div class="fldblks">
                    <select name="cmbRequirement" id="cmbRequirement" class="chzn-select fild" tabindex="4">
                        ...
                        foreach ($allrequirement as $key => $row):
                            ?>
                            <option value="<?php echo $key; ?>" <?php if($RequirementId==$key){ echo "selected=selected"; }?>><?php echo $row; ?></option>
                            <?php
                        endforeach;
                        ?>
                    </select>
                ...
                <div class="fldblks">
                    <select name="cmbProperty" id="cmbProperty" class="fild chzn-select" tabindex="6">
                        ...
                        foreach ($allproperty as $key => $row):
                            ?>
                            <option value="<?php echo $key; ?>" <?php if($PropertyId==$key){ echo "selected=selected"; }?>><?php echo $row; ?></option>
                            <?php
                        endforeach;
                        ?>
                    </select>
