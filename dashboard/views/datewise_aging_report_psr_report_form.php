...
<h2>PROPERTY AGING REPORT</h2>
    <div class="mfrminner">

       <form name="frmWeeklyReport" id="frmWeeklyReport" method="post" action="<?php echo base_url();?>index.php/dashboard/property_aging_report" target="_blank">
