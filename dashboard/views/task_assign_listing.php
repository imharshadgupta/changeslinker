...
// var_dump($row);die;
                        ...
                        $TaskAssignDateTimeHidden = strtotime($getTaskAssignDateTime);
                        ...
                        if (!empty($row['dTaskTargetDateTime']) && ($row['dTaskTargetDateTime'] != '0000-00-00 00:00:00')) {
                            ...
                            $TaskTargetDateTimeHidden = strtotime($getTaskTargetDateTime);
                        } else {
                            $TaskTargetDateTime = "";
                            $TaskTargetDateTimeHidden = 0;
                        }
                        ...
                        <!--<td style="text-align:center;"><?php //echo $SNo; ?>.</td>-->
                            <td style="text-align:left;"><span class='hide'><?php echo $TaskAssignDateTimeHidden ?></span><?php echo $TaskAssignDateTime; ?></td>
                    ...
                    <!--<td style="text-align:left;"><?php //echo $PropertyName; ?></td>-->
                            ...
                            <td style="text-align:left;"><span class="hide"><?php echo $TaskTargetDateTimeHidden; ?></span><?php echo $TaskTargetDateTime; ?></td>
