...
<input type="hidden" name="hfStateId" id="hfStateId" value="<?php echo set_value('hfStateId',$StateId); ?>"/>
...
<div class="fldblks"><input type="text" name="txtStateName" id="txtStateName" class="fild" value="<?php echo set_value('txtStateName',$StateName); ?>" tabindex="1" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">State Abbreviation</div>
<div class="fldblks"><input type="text" name="txtStateAbbreviation" id="txtStateAbbreviation" class="fild" value="<?php echo set_value('txtStateAbbreviation',$StateAbbreviation); ?>" tabindex="2" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
function FormValidate(btn)
{
    ...
    else
    {
		...
		var url = "<?php echo base_url(); ?>index.php/dashboard/edit_state_master";
