...
<h2>Weekly Report</h2>
    <div class="mfrminner">
       ...
       <form name="frmWeeklyReport" id="frmWeeklyReport" method="post" action="<?php echo base_url();?>index.php/dashboard/dwweeklyprintreport" target="_blank">
 
        <fieldset><legend>Weekly Report</legend>
