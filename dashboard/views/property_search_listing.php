...
<div class="mfrminner">
	...
	<div class="fldblks">
		<select name="cmbCity" id="cmbCity" class="fild chzn-select" tabindex="2" onchange="getLocationByCityIdAndDistrictIdAndStateId()">
    ...
    function getLocationByCityIdAndDistrictIdAndStateId()
    {
        ...
        else
        {
            $.ajax({
                ...
                data: "cmbState="+$("#cmbState").val()+"&searchcheckcity=1"+"&cmbCity="+$("#cmbCity").val(),
