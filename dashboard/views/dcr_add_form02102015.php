...
$(document).ready(function(){
	...
	$("#addButton").click(function() {
	   ...
	   var  maincontent1="<div style='width:3%; height:100%; text-align:center; float:left; border:0px solid red;'>"+counter+".</div>";
			...
			$("#txtTaskAssignDateTime"+counter).datetimepicker({
				dateFormat: 'dd/mm/yy',
				controlType: 'select',
				oneLine: true,
				timeFormat: 'hh:mm tt',
			...
			$("#txtTaskAssignDateTime"+counter).val(defaultcurrdt);
			
			$("#txtTaskTargetDateTime"+counter).datetimepicker({
				dateFormat: 'dd/mm/yy',
				controlType: 'select',
				oneLine: true,
				timeFormat: 'hh:mm tt',
			...
			$("#txtReminderDateTime"+counter).datetimepicker({
				dateFormat: 'dd/mm/yy',
				controlType: 'select',
				oneLine: true,
				timeFormat: 'hh:mm tt',
   ...
   //$("#txtDCRDate").datepicker("setDate",currentDate);
	...
	$("#txtTaskAssignDateTime1").datetimepicker({
		dateFormat: 'dd/mm/yy',
		controlType: 'select',
		oneLine: true,
		timeFormat: 'hh:mm tt',
	...
	$("#txtTaskAssignDateTime1").val(defaultcurrdt);
	
	$("#txtTaskTargetDateTime1").datetimepicker({
		dateFormat: 'dd/mm/yy',
		controlType: 'select',
		oneLine: true,
		timeFormat: 'hh:mm tt',
	...
	$("#txtReminderDateTime1").datetimepicker({
		dateFormat: 'dd/mm/yy',
		controlType: 'select',
		oneLine: true,
		timeFormat: 'hh:mm tt',
