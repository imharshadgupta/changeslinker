...
<div class="inner_form">
    ...
    <form name="searchForm" id="searchForm" method="post" action="<?php echo base_url(); ?>index.php/dashboard/search">
        ...
        <div class="mfrminner">
            ...
            <div class="fldblks">
                <select name="cmbFilter" id="cmbFilter" class="fild chzn-select" style="width:200px;" tabindex="1">
...
?>>Requisition</option>
            ...
            <div class="fldblks">
                <input type="text" name="txtSearch" id="txtSearch" class="fild" style="width:200px;" value="<?php echo set_value('txtSearch'); ?>" tabindex="2" />
                &nbsp;&nbsp;</div>
            <div class="clear"></div>
            ...
            <div class="fldblks">
                <select name="cmbPropertyStatus" id="cmbPropertyStatus" class="fild chzn-select" tabindex="5">
            ...
            <div class="fldblks">
                <select name="cmbAvailabilityStatus" id="cmbAvailabilityStatus" class="fild chzn-select" tabindex="6">
                <option value="">Select Availability Status</option>            
                <option value="Available" 
                <?php if(isset($_POST['cmbAvailabilityStatus']) && ($_POST['cmbAvailabilityStatus'] == 'Available')) echo ' selected="selected"'; ?>>Available</option>
                <option value="Not Available" <?php if(isset($_POST['cmbAvailabilityStatus']) && ($_POST['cmbAvailabilityStatus'] == 'Not Available')) echo ' selected="selected"'; ?>>Not Available</option>
                </select>
            </div>

            <div class="Txtblks">State</div>
            <div class="fldblks">
                <select name="cmbState" id="cmbState" class="fild chzn-select" tabindex="7" onchange="getCityByDistrictIdAndStateId()">
                    <option value="">Select State</option>
                    <?php
                    $this->db->order_by('cStateName', 'asc');
                    $this->db->where('bActive', 1);
            ...
            <div class="fldblks">
                <select name="cmbCity" id="cmbCity" class="fild chzn-select" tabindex="8" onchange="getLocationByCityIdAndDistrictIdAndStateId()">
            ...
            <div class="fldblks">
                <select name="cmbLocation" id="cmbLocation" class="fild chzn-select" tabindex="9">
                    <option value="">Select Location</option>
                </select>
            </div>
            <div class="Txtblks">&nbsp;</div>
            <div class="fldblks"><input type='button' class="btn" value="Submit" onclick="ValidateSearch();" style="margin-top: 20px;" /></div>
            <div class="clear"></div>
...
<?php
if(isset($_POST['cmbCity']) && isset($_POST['cmbState'])) {
?>
