...
<div class="fldblks"><input type="text" name="txtPropertyTaglineForWebsite" id="txtPropertyTaglineForWebsite" class="fild" value="<?php echo set_value('txtPropertyTaglineForWebsite',$PropertyTaglineForWebsite); ?>" tabindex="17" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
<div class="fldblks"><textarea name="txtPowerLoad" id="txtPowerLoad" class="fild" tabindex="50"><?php echo set_value('txtPowerLoad',$PowerLoad); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Power Backup</div>
<div class="fldblks"><textarea name="txtPowerBackup" id="txtPowerBackup" class="fild" tabindex="51"><?php echo set_value('txtPowerBackup',$PowerBackup); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
<div class="fldblks">
	<select name="cmbAgreementType" id="cmbAgreementType" class="fild" tabindex="34">
...
<div class="fldblks"><textarea name="txtDemandPerSqFeet" id="txtDemandPerSqFeet" class="fild" tabindex="35"><?php echo set_value('txtDemandPerSqFeet',$DemandPerSqFeet); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Demand (Gross)(INR)</div>
<div class="fldblks"><textarea name="txtDemandGross" id="txtDemandGross" class="fild" tabindex="36"><?php echo set_value('txtDemandGross',$DemandGross); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Security Deposit</div>
<div class="fldblks"><textarea name="txtSecurityDeposit" id="txtSecurityDeposit" class="fild" tabindex="37"><?php echo set_value('txtSecurityDeposit',$SecurityDeposit); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
<div class="fldblks">
	<select name="cmbEscalation" id="cmbEscalation" class="fild" tabindex="38">
...
<div class="fldblks"><input type="text" name="txtCAM" id="txtCAM" class="fild" value="<?php echo set_value('txtCAM',$CAM); ?>" tabindex="39" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Service Tax on Lessor (INR)</div>
<div class="fldblks"><input type="text" name="txtServiceTaxOnLessor" id="txtServiceTaxOnLessor" class="fild" value="<?php echo set_value('txtServiceTaxOnLessor',$ServiceTaxOnLessor); ?>" tabindex="40" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Service Tax on Lessee (INR)</div>
<div class="fldblks"><input type="text" name="txtServiceTaxOnLessee" id="txtServiceTaxOnLessee" class="fild" value="<?php echo set_value('txtServiceTaxOnLessee',$ServiceTaxOnLessee); ?>" tabindex="41" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Property Tax on Lessor (INR)</div>
<div class="fldblks"><input type="text" name="txtPropertyTaxOnLessor" id="txtPropertyTaxOnLessor" class="fild" value="<?php echo set_value('txtPropertyTaxOnLessor',$PropertyTaxOnLessor); ?>" tabindex="42" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Property Tax on Lessee (INR)</div>
<div class="fldblks"><input type="text" name="txtPropertyTaxOnLessee" id="txtPropertyTaxOnLessee" class="fild" value="<?php echo set_value('txtPropertyTaxOnLessee',$PropertyTaxOnLessee); ?>" tabindex="43" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
<div class="fldblks">
<select name="cmbStampDutyAndRegistration" id="cmbStampDutyAndRegistration" class="fild" tabindex="44">
...
<div class="fldblks">
<select name="cmbLockIn" id="cmbLockIn" class="fild" tabindex="45">
...
<div class="fldblks"><textarea name="txtLockInDuration" id="txtLockInDuration" class="fild" tabindex="46"><?php echo set_value('txtLockInDuration',$LockInDuration); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
<div class="fldblks">
<select name="cmbRentFreePeriod" id="cmbRentFreePeriod" class="fild" tabindex="47">
...
<div class="fldblks"><input type="text" name="txtNoticePeriod" id="txtNoticePeriod" class="fild" value="<?php echo set_value('txtNoticePeriod',$NoticePeriod); ?>" tabindex="48" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Possession Status</div>
<div class="fldblks"><input type="text" name="txtPossessionStatus" id="txtPossessionStatus" class="fild" value="<?php echo set_value('txtPossessionStatus',$PossessionStatus); ?>" tabindex="49" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
<div class="submit"><input type="button" name="btnSubmit" class="btn" value="Submit" onclick="FormValidate(this)" />&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/dashboard/listing_property_master"><input type="button" name="btnBack" id="btnBack" class="btn" value="Back" /></a></div>
		...
		$.post(url,data,function(responsedata,status){
			...
			if(responsedata)
			{
				...
				{					
					...
					var redirecturl = "<?php echo base_url(); ?>index.php/dashboard/listing_property_master";
