...
<div class="fldblks"><input type="text" name="txtCallTypeName" id="txtCallTypeName" class="fild" value="<?php echo set_value('txtCallTypeName'); ?>" tabindex="1" /></div>
...
function FormValidate(btn)
{
    ...
    else
    {
		...
		var url = "<?php echo base_url(); ?>/index.php/dashboard/add_call_type_master";
