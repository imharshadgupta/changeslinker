...
<input type="hidden" name="hfInspectionRecordId" id="hfInspectionRecordId" value="<?php echo set_value('hfInspectionRecordId',$InspectionRecordId); ?>"/>
...
<div class="fldblks"><input type="text" name="txtInspectionDate" id="txtInspectionDate" class="fild" style="width:302px;" value="<?php echo set_value('txtInspectionDate',$InspectionDate); ?>" readonly="readonly" tabindex="1" /></div>
...
<div class="fldblks"><textarea name="txtPeopleAtTheTimeOfInspection" id="txtPeopleAtTheTimeOfInspection" class="fild" tabindex="4"><?php echo set_value('txtPeopleAtTheTimeOfInspection',$PeopleAtTheTimeOfInspection); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Inspection Summary</div>
<div class="fldblks"><textarea name="txtInspectionSummary" id="txtInspectionSummary" class="fild" tabindex="5"><?php echo set_value('txtInspectionSummary',$InspectionSummary); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
...
function FormValidate(btn)
{
    ...
    else
    {
		...
		var url = "<?php echo base_url(); ?>/index.php/dashboard/edit_inspection_record";
