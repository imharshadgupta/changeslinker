...
<fieldset>
	...
	foreach($DCRDetailRows as $dcrdetrow)
	{
		...
		$CurrentStatus = trim($dcrdetrow['cCurrentStatus']);
		...
		<div class='TBGroup'>
			<div class="row">
				...
				<div style="width:13%; height:100%; float:left; border:0px solid blue;">
					<select name="cmbClientReq[]" id="cmbExistClientReq<?php echo $i; ?>" class="selected_client_req_existing chzn-select fild" onchange="getReqByClient(<?php echo $i; ?>);" tabindex="2">
				...
				<div style="width:1%; height:100%; float:left; border:0px solid red;">&nbsp;</div>
				<div style="width:13%; height:100%; float:left; border:0px solid blue;">
					<select name="cmbClientProp[]" id="cmbExistClientProp<?php echo $i; ?>" class="selected_client_prop_existing chzn-select fild" onchange="getPropByClient(<?php echo $i; ?>);" tabindex="4">
					<option value="">Select Client</option>
					<?php 
						$this->db->where('bActive', 1);
						$this->db->where('bDelete', 0);
				...
				<div style="width:1%; height:100%; float:left; border:0px solid red;">&nbsp;</div>
				<div style="width:13%; height:100%; float:left; border:0px solid blue;"><input type="text" name="txtCurrentStatus[]" id="txtExistCurrentStatus<?php echo $i; ?>" class="selected_current_status fild" style="width:110px;" value="<?php echo set_value('txtCurrentStatus'.$i,$CurrentStatus); ?>" tabindex="6" /></div>
...
<fieldset>
	...
	<div id='TextBoxesGroup' class='TBGroup'>
		<div id="TextBoxDiv1" class="row" style="height:35px; border:0px solid green;">
			...
			<div style="width:1%; height:100%; float:left; border:0px solid red;">&nbsp;</div>
			<div style="width:13%; height:100%; float:left; border:0px solid blue;"><input type="text" name="txtCurrentStatus[]" id="txtCurrentStatus1" class="selected_current_status fild" style="width:110px;" value="<?php echo set_value('txtCurrentStatus1'); ?>" tabindex="6" /></div>
...
$(document).ready(function(){
	...
	$("#addButton").click(function() {
	   ...
	   var  maincontent1="<div style='width:3%; height:100%; text-align:center; float:left; border:0px solid red;'>"+counter+".</div>";
			...
			maincontent1+="<div style='width:1%; height:100%; float:left; border:0px solid red;'>&nbsp;</div>";
			maincontent1+="<div style='width:13%; height:100%; float:left; border:0px solid blue;'><input type='text' name='txtCurrentStatus[]' id='txtCurrentStatus"+counter+"' class='current_status fild' style='width:110px;' value='<?php echo set_value('txtCurrentStatus[]'); ?>' /></div>";
