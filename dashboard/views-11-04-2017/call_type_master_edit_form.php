...
<input type="hidden" name="hfCallTypeId" id="hfCallTypeId" value="<?php echo set_value('hfCallTypeId',$CallTypeId); ?>"/>
...
<div class="fldblks"><input type="text" name="txtCallTypeName" id="txtCallTypeName" class="fild" value="<?php echo set_value('txtCallTypeName',$CallTypeName); ?>" tabindex="1" /></div>
...
<div class="submit"><input type="button" name="btnSubmit" class="btn" value="Submit" onclick="FormValidate(this)" />&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/dashboard/listing_call_type_master"><input type="button" name="btnBack" id="btnBack" class="btn" value="Back" /></a></div>
...
function FormValidate(btn)
{
    ...
    else
    {
		...
		var url = "<?php echo base_url(); ?>/index.php/dashboard/edit_call_type_master";
		...
		$.post(url,data,function(data){	
		    ...
		    if(data)
			{
				...
				{					
					...
					btn.value = 'Submit';
					alert(data.msg);
					var redirecturl = "<?php echo base_url(); ?>/index.php/dashboard/listing_call_type_master";
