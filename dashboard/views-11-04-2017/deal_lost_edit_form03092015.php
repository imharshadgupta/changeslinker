...
<div class="fldblks">
	<select name="cmbClientProp" id="cmbClientProp" class="chzn-select fild" onchange="getPropertyByClient();" tabindex="4">
	<option value="">Select Client</option>
	<?php
		$this->db->order_by("cClientName", "asc");
		$this->db->where('bActive', 1);
...
<div class="fldblks"><textarea name="txtDealSummaryLostReason" id="txtDealSummaryLostReason" class="fild" tabindex="6"><?php echo set_value('txtDealSummaryLostReason',$DealSummaryLostReason); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
