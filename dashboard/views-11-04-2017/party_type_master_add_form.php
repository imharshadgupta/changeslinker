...
<div class="fldblks"><input type="text" name="txtPartyTypeName" id="txtPartyTypeName" class="fild" value="<?php echo set_value('txtPartyTypeName'); ?>" tabindex="1" /></div>
...
function FormValidate(btn)
{
    ...
    else
    {
		...
		var url = "<?php echo base_url(); ?>/index.php/dashboard/add_party_type_master";
