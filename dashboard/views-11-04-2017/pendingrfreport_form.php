...
<h2>PENDING RF REPORT</h2>
    <div class="mfrminner">

       <form name="frmWeeklyReport" id="frmWeeklyReport" method="post" action="<?php echo base_url();?>index.php/dashboard/pendingrfreport" target="_blank">
