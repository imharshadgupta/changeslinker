...
<div class="fldblks"><input type="text" name="txtPropertyTypeName" id="txtPropertyTypeName" class="fild" value="<?php echo set_value('txtPropertyTypeName'); ?>" tabindex="1" /></div>
...
function FormValidate(btn)
{
    ...
    else
    {
		...
		var url = "<?php echo base_url(); ?>/index.php/dashboard/add_property_type_master";
