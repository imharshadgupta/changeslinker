...
<form name="addForm" id="addForm" method="post" action="<?php echo base_url(); ?>/index.php/dashboard/add_deal_initiate" enctype="multipart/form-data" target="_blank">
...
?>
                ...
                <div class="fldblks">
                    <select name="cmbPossessionDone" id="cmbPossessionDone" class="fild chzn-select" tabindex="12">
                ...
                <div class="fldblks">
                    <select name="cmbPaymentReceivedCompletely" id="cmbPaymentReceivedCompletely" class="fild chzn-select" tabindex="14">
            ...
            <div class="submit"><input type="button" name="btnSubmit" class="btn" value="Submit" onclick="FormValidate(this);" />
                ...
                &nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/dashboard/listing_deal_initiate"><input type="button" name="btnBack" id="btnBack" class="btn" value="Back" /></a></div>
