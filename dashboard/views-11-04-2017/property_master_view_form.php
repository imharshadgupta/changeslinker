...
<div class="fldblks"><textarea readonly="readonly" name="cSurroundingBrands" id="cSurroundingBrands" class="fild" tabindex="16"><?php echo set_value('cSurroundingBrands',$cSurroundingBrands); ?></textarea></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>

<div class="Txtblks">Tagline for Website</div>
<div class="fldblks"><input type="text" name="cPropertyTaglineForWebsite" id="cPropertyTaglineForWebsite" class="fild" value="<?php echo set_value('cPropertyTaglineForWebsite',$cPropertyTaglineForWebsite); ?>" readonly="readonly" tabindex="17" /></div>
<div class="Txtblks">&nbsp;</div>
<div class="fldblks">&nbsp;</div>
<div class="clear"></div>
