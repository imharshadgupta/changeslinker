...
<h2>PSR PENDING FOR ACCEPTANCE REPORT</h2>
    <div class="mfrminner">

       <form name="frmWeeklyReport" id="frmWeeklyReport" method="post" action="<?php echo base_url();?>index.php/dashboard/psrpendingacceptanceprintreport" target="_blank">
