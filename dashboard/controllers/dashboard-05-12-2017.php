...
// SQL server connection information
    ...
    function drilldown_report($client_id = 0) {
        ...
        $data['taskid'] = $taskid = trim($this->input->get('taskid'));
        $data['userid'] = $userid = trim($this->input->get('user_id'));
        $data['formdate'] = $formdate = trim($this->input->get('formdate'));
        $data['todate'] = $todate = trim($this->input->get('todate'));
