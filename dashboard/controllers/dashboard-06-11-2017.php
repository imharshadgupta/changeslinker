    ...
    function search() {
        if (isset($_POST['cmbFilter']) && ($_POST['cmbFilter'] != '')) {
            ...
            if ($Filter == 'Property') {
                ...
                $data['query'] = $this->dashboard_model->search_by_text_in_property($txtSearch, $cmbPropertyCategory, $cmbPropertyType, $cmbPropertyStatus, $cmbState, $cmbCity, $cmbLocation);
                $data['page_url'] = "search_listing";
                $this->load->view('includes/template', $data);
            }
            ...
            if ($Filter == 'Client') {
                ...
                $data['Filter'] = "Client";
                $data['txtSearch'] = $txtSearch;
                $data['query'] = $this->dashboard_model->search_by_text_in_client($txtSearch, $cmbPropertyCategory, $cmbPropertyType, $cmbPropertyStatus, $cmbState, $cmbCity, $cmbLocation);
                $data['page_url'] = "search_listing";
                $this->load->view('includes/template', $data);
            }
            ...
            if ($Filter == 'Requisition') {
                ...
                $data['txtSearch'] = $txtSearch;
                $data['query'] = $this->dashboard_model->search_by_text_in_requirement($txtSearch, $cmbPropertyCategory, $cmbPropertyType, $cmbPropertyStatus, $cmbState, $cmbCity, $cmbLocation);
                $data['page_url'] = "search_listing";
                $this->load->view('includes/template', $data);
            }
        } else {
