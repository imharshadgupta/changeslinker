...
//                }
   ...
   function smtpmailer($to, $from, $from_name, $subject, $body) {
       ...
       $mail = new PHPMailer();
        ...
        function sendEmailtest($RecipientEmailAddress,$EmailSubject,$EmailMessage)
	{       
		...
		$mail->Body  	 = "hiiiiiiiiihru";
		
		$mail->AltBody    = "To view the message, please use an HTML compatible email viewer!";
		
		$mail->AddAddress(""); 	   // Who is addressed the email to
